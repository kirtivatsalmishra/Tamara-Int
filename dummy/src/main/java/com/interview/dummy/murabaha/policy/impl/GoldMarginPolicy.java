...
@Component
public class GoldMarginPolicy implements CommodityMarginPolicy {

    private static final BigDecimal MARGIN = new BigDecimal("8.00");

    @Override
    public boolean supports(CommodityCategory category) {
        return "gold".equals(category.code());
    }
